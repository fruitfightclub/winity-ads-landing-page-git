...
const REGIONS = [
  {
    ...
    count: 44,
    countries: [
      'Albania','Andorra','Austria','Belgium','Bosnia and Herzegovina','Croatia','Czech Republic',
  ...
  },
  {
    ...
    countries: [
      ...
      'East Timor (Timor-Leste)','Gaza Strip','Georgia','Hong Kong','Japan',
      'Kazakhstan','Kuwait','Kyrgyzstan','Laos','Macau','Malaysia','Maldives','Mongolia',
  ...
  },
  {
    ...
    count: 35,
    countries: [
      'Algeria','Angola','Benin','Botswana','Cabo Verde (Cape Verde)','Cameroon',
      'Chad','Comoros',"Côte d'Ivoire",'Djibouti','Egypt',
      'Equatorial Guinea','Eswatini (Swaziland)','Ethiopia','Gabon','The Gambia','Ghana',
      'Guinea','Kenya','Lesotho','Madagascar','Malawi','Mauritania','Mauritius','Mayotte',
      'Niger','Nigeria','Réunion','Saint Helena','Sao Tome and Principe','Senegal',
      'Seychelles','South Africa','Togo','Tunisia','Uganda','Western Sahara','Zambia',
    ],
  },
  {
  ...
  },
  {
    ...
    count: 13,
    countries: [
      'Argentina','Bolivia','Brazil','Colombia','Ecuador','Falkland Islands',
  ...
  },
  {
    ...
    count: 23,
    countries: [
      'American Samoa','Australia','Cocos (Keeling) Islands','Cook Islands','Fiji',
      'French Polynesia','Guam','Kiribati','Marshall Islands','Micronesia','Nauru',
      'New Caledonia','New Zealand','Niue','Northern Mariana Islands','Papua New Guinea',
      'Pitcairn Island','Samoa','Solomon Islands','Tokelau','Tonga','Tuvalu','Vanuatu',
      'Wallis and Futuna',
    ],
  },
]
