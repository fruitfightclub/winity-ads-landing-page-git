...
const USE_CASES = [
  ...
  },
  {
    ...
    badge: '💳 One card, full visibility',
    accent: MINT,
    image: '/uc_saas.png',
  ...
  },
  {
    ...
    tag: 'Travel & Hotels',
    headline: 'Spend like\na local, anywhere.',
    sub: 'From Dubai to Tokyo, pay at hotels, restaurants, and retail. Your card works at 150M+ Visa® locations across 180+ countries.',
    platforms: ['Booking.com', 'Airbnb', 'Expedia', 'Hotels'],
    badge: '✈️ 180+ countries supported',
    accent: COPPER_LT,
    image: '/uc_travel.png',
