...
const USE_CASES = [
  {
    ...
    accent: MINT,
    image: '/uc_digital_marketing.webp',
    imageFallback: '/ads_1.webp',
    stat: '150M+',
  ...
  },
  {
    ...
    accent: COPPER_LT,
    image: '/uc_travel.webp',
    imageFallback: '/winity_lifestyle_travel.webp',
    stat: '200+',
  ...
  },
  {
    ...
    accent: MINT,
    image: '/uc_shopping.webp',
    imageFallback: '/winity_gallery_culture.webp',
    stat: '1pt',
  ...
  },
  {
    ...
    accent: MINT,
    image: '/uc_freelancers.webp',
    imageFallback: '/ads_3.webp',
    stat: 'Automatic',
          ...
          {USE_CASES.map((_, i) => (
            <button
              ...
              style={{
                ...
                width: 32,
                transform: `scaleX(${i === active ? 1 : 0.375})`,
