...
const EXPERIENCE_SHOWCASES = [
  ...
  },
  {
    ...
    img: '/winity_lifestyle_dining.webp',
  ...
  },
  {
    ...
    img: '/winity_lifestyle_travel.webp',
      ...
      <div className="container-wide relative z-10">
        ...
        <div ref={headerRef} style={{ textAlign: 'center', marginBottom: 'clamp(48px,6vh,72px)', opacity: 0 }}>
          ...
          <h2 style={{
            ...
            Points that open <span style={{ background: 'linear-gradient(135deg, #21E6A7 0%, #0CF5BC 45%, #0ECFB5 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>the world.</span>
          </h2>
          <p style={{
