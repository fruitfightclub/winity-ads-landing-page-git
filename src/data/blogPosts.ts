...
export const BLOG_POSTS: BlogPost[] = [
  // ─── Post 1: How to spend USDT — from client Blog_01 ──────────────────────
  {
    ...
    content: [
      ...
      { type: 'paragraph', text: 'Download the Winity Life app on iOS or Android. KYC verification completes within minutes using a passport, driving licence, or national ID. Once approved, your Winity Exclusive virtual card is issued immediately, with zero annual fee and ready for Google Pay.' },
      ...
      { type: 'callout', text: 'No annual fee on the virtual tier. Zero stablecoin load fees. The card costs nothing to hold.' },
  ...
  // ─── Post 4: USDT to dinner — how the conversion works ────────────────────
  {
    ...
    content: [
      ...
      { type: 'callout', text: 'Zero annual fee on the virtual card. Zero stablecoin load fees. The Winity Exclusive card costs nothing to hold.' },
  ...
  // ─── Post 8: Exclusive card — free physical card guide (rewritten) ─────────
  {
    ...
    content: [
      ...
      { type: 'paragraph', text: 'Your Winity Exclusive virtual card carries no annual fee. Stablecoin loads (USDT and USDC) arrive with zero platform load fee. The virtual card is issued immediately after KYC approval. No waiting for shipping, no activation fee.' },
