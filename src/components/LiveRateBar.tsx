...
export default function LiveRateBar() {
  ...
  return (
    ...
    >
      ...
      {/* Left fade */}
      <div style={{
        position: 'absolute', left: 0, top: 0, bottom: 0, width: 80, zIndex: 10, pointerEvents: 'none',
        background: 'linear-gradient(to right, #040F10, transparent)',
      }} />
      {/* Right fade */}
      <div style={{
        position: 'absolute', right: 0, top: 0, bottom: 0, width: 80, zIndex: 10, pointerEvents: 'none',
        background: 'linear-gradient(to left, #040F10, transparent)',
      }} />

      {/* Live dot + label — pinned left */}
      <div style={{
        position: 'absolute', left: 16, top: 0, bottom: 0, zIndex: 20,
        ...
        <span style={{
          ...
          textTransform: 'uppercase' as const, color: 'rgba(33,230,167,0.6)',
